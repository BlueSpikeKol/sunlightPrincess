						...
						if ((excludedTypes == null || !excludedTypes.Contains(movement.GetType())) && setter.DeclaringType.IsAssignableFrom(movement.GetType()))
						{
							try
							{
                                if(setter.FieldType == typeof(System.Boolean))
                                {
                                    ...
                                    setter.SetValue(movement, v);
                                }
                                else if(setter.FieldType == typeof(System.Int32))
                                {
                                    var v = System.Convert.ToInt32(value);
                                    setter.SetValue(movement, v);
                                }
                                else if(setter.FieldType == typeof(System.Single))
                                {
                                ...
                                {
                                    Debug.LogWarning("The type of the value to set is not supported");
                                }
							}
					...
					foreach (Movement movement in movements)
					{
						if ((excludedTypes == null || !excludedTypes.Contains(movement.GetType())) && setter.DeclaringType.IsAssignableFrom(movement.GetType()))
						{
							try
							{
                                ...
                                {
                                    var v = System.Convert.ToBoolean(value);
                                    setter.SetValue(movement, (bool)setter.GetValue(movement) || v);
                                }
                                else if(setter.FieldType == typeof(System.Int32))
                                {
                                    var v = System.Convert.ToInt32(value);
                                    setter.SetValue(movement, (int)setter.GetValue(movement) + v);
                                }
                                else if(setter.FieldType == typeof(System.Single))
                                {
                                    var v = System.Convert.ToSingle(value);
                                    setter.SetValue(movement, (float)setter.GetValue(movement) + v);
                                }
                                else
                                {
                                    Debug.LogWarning("The type of the value to set is not supported");
